...
const headersWaldo = [
  ...
  },
  {
    ...
    chipList: [
      ...
      { id: 4, label: 'surgeryyyyy', color: '#FFBBFF', colorHover: '#99BB99', icon: AdjustRoundedIcon, iconStyle: iconButtonStylePurple,},
  ...
  },
  {
    ...
    buttonList: [
      ...
      { id: 2, caption: 'asdlk',       color: '#FFFFBB', colorHover: '#FFFF88', icon: AdjustRoundedIcon, iconStyle: iconButtonStyleOrange, },
